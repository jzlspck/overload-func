...
type PickMatchingFunctions<ET extends Record<string, any>, TN extends TypeName<ET>[], TF extends FT[]> = TF extends [infer F, ...infer R] ? F extends FT ? LooseEqual<Parameters<F>, TypeNameToType<ET, TN>> extends true ? F : PickMatchingFunctions<ET, TN, R extends FT[] ? R : []> : never : never;
